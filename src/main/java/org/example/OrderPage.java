...
public class OrderPage {
    ...
    public void enterOrderRentData(String dataRentStart, String deliveryComments, String color, String rentDays) {
        ...
        driver.findElement(By.xpath("//*[@class='Dropdown-option' and text()='" + rentDays + "']")).click();
